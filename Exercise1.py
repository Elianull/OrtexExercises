...
with open('2017.csv', encoding='utf8') as file:
    ...
    print('Jan, {}%'.format(round(count[0]/total*100),4)) #Output formatted response with rounded value
    print('Feb, {}%'.format(round(count[1]/total*100),4))
    print('Mar, {}%'.format(round(count[2]/total*100),4))
    print('Apr, {}%'.format(round(count[3]/total*100),4))
    print('May, {}%'.format(round(count[4]/total*100),4))
    print('Jun, {}%'.format(round(count[5]/total*100),4))
    print('Jul, {}%'.format(round(count[6]/total*100),4))
    print('Aug, {}%'.format(round(count[7]/total*100),4))
    print('Sep, {}%'.format(round(count[8]/total*100),4))
    print('Oct, {}%'.format(round(count[9]/total*100),4))
    print('Nov, {}%'.format(round(count[10]/total*100),4))
    print('Dec, {}%'.format(round(count[11]/total*100),4))
